...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata_mode=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Tetris_botz" -metadata author="@tetris_admino_bot" -metadata:s:s title="Subtitled By :- @tetris_Botz" -metadata:s:a title="By :- @tetris_admino_bot" -metadata:s:v title="By:- @Tetris_Botz" """,
            expiry_time=None,
